...
func main() {
	...
	data := struct {
		...
		BlocksStorageConfigBlock: generateBlockMarkdown(blocks, "blocks_storage", "blocks_storage"),
		StoreGatewayConfigBlock:  generateBlockMarkdown(blocks, "store_gateway", "store_gateway"),
		CompactorConfigBlock:     generateBlockMarkdown(blocks, "compactor", "compactor"),
		QuerierConfigBlock:       generateBlockMarkdown(blocks, "querier", "querier"),
		S3SSEConfigBlock:         generateBlockMarkdown(blocks, "s3_sse", "sse"),
